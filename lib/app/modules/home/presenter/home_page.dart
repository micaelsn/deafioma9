  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Observer(
              builder: (_) => controller.moviesListFavorites.length > 0
                  ? Column(
                      ...
                      children: <Widget>[
                          ...
                          Container(
                            ...
                            child: ListView.builder(
                                ...
                                itemCount:
                                    controller.moviesListFavorites.length ?? 0,
                                itemBuilder: (BuildContext context, int index) {
                                  return new MovieItemHorizontalComponent(
                                    movieItem:
                                        controller.moviesListFavorites[index],
                                    onPressed: () {
                                      controller.removeFavorite(controller
                                          .moviesListFavorites[index]);
                                    },
                                  );
                                }),
                          ),
